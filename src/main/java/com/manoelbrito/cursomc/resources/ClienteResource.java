...
import com.manoelbrito.cursomc.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Page<ClienteDTO>> findPage(
		...
		return ResponseEntity.ok().body(service.findPage(page, linesPerPage, orderBy, direction).map(obj-> new ClienteDTO(obj)));
	}
}
